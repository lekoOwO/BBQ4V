...
router.route('/')
    ...
    .get(function (req, res) {
        ...
        groups.items(req, function (err, results, fields) {
            if (err) {
                res.sendStatus(500);
...
router.route('/:id')
    .get(function (req, res) {
        groups.item(req, function (err, results, fields) {
            if (err) {
                res.sendStatus(500);
                return console.error(err);
            }
    ...
    .delete(oauth2.accessControl(["admin"]), function (req, res) {        
        groups.delete(req, function (err, results, fields) {
            if (err) {
                res.sendStatus(500);
                return console.error(err);
            }
    ...
    .put(oauth2.accessControl(["admin"]), function (req, res) {
        groups.put(req, function (err, results) {
            if (err) {
                res.sendStatus(500);
                return console.error(err);
            }
    ...
    .patch(oauth2.accessControl(["admin"]), function (req, res) {
        groups.patch(req, function (err, results, fields) {
            if (err) {
                res.sendStatus(500);
                return console.error(err);
            }
